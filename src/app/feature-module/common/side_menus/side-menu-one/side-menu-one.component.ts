...
export class SideMenuOneComponent implements OnDestroy {
  ...
  base = 'dashboard';
  page = '';
  Tracking: string = routes.tracking;
  userType: string | null = localStorage.getItem('UserTypeCode');
  ProfileCreation: string = routes.profilecreation;
  ActivityTracking: string = routes.activitytracking;
  GoalSetting: string = routes.goalsetting;
  ProgressTracking: string = routes.progresstracking;
